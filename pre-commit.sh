...
then
cp rgb.ino.generic.bin build/build.0x00000_flash_size_1Mb.254Kb_`date '+%G.%m.%d'`.bin
fi


cp /tmp/buil*.spiffs/rgb.spiffs.bin ./build/spiffs.0xBB000_flash_size_1Mb.254Kb_`date '+%G.%m.%d'`.bin
